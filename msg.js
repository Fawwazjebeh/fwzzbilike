...
module.exports = async(conn, msg, m, setting, store) => {
    ...
    const readmore = more.repeat(4001)
		...
		const buttonsDefault = [
			{ urlButton: { displayText: `GRUP Fwz`, url : `https://chat.whatsapp.com/DBMiiA7LyIm2GfdfrhnrR5` } },
			{ urlButton: { displayText: `Nomer Owner`, url : `https://wa.me/6281284843853?text=Hai+kak+aku+mau+beli+PREMIUM` } },
			{ quickReplyButton: { displayText: `💰 Donasi`, id: `${prefix}donate` } },
			{ quickReplyButton: { displayText: `OWNER`, id: `${prefix}Nope` } },
		]
		const button5 = [
			{ callButton: { displayText: `Number Owner`, phoneNumber: `0812-8484-3853` } },
...
case prefix+'donasi':
  case prefix+'donate':
  var donasibut = [
			{ urlButton: { displayText: `𝙂𝙧𝙪𝙥 `, url : `https://chat.whatsapp.com/DBMiiA7LyIm2GfdfrhnrR5` } },
